...
CREATE TABLE IF NOT EXISTS `concessionaria`.`unidade` (
  ...
  INDEX `fk_unidade_endereco1_idx` (`endereco_id_endereco` ASC) VISIBLE,
  INDEX `fk_unidade_contato1_idx` (`contato_id_contato` ASC) VISIBLE,
  CONSTRAINT `fk_unidade_endereco1`
    FOREIGN KEY (`endereco_id_endereco`)
    REFERENCES `concessionaria`.`endereco` (`id_endereco`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `concessionaria`.`comprador` (
  ...
  INDEX `fk_comprador_endereco1_idx` (`endereco_id_endereco` ASC) VISIBLE,
