...
CREATE TABLE IF NOT EXISTS `clinica`.`tutor` (
  ...
  `nome_tutor` VARCHAR(100) NULL,
  `data_nasc_tutor` DATE NULL,
...
-- -----------------------------------------------------
-- Table `clinica`.`unidade`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `clinica`.`unidade` ;

CREATE TABLE IF NOT EXISTS `clinica`.`unidade` (
  `id_unidade` INT NOT NULL,
  `nome` VARCHAR(45) NULL,
  `whatsapp` VARCHAR(15) NULL,
  `fixo` VARCHAR(15) NULL,
  `endereco_cep` VARCHAR(8) NOT NULL,
  `endereco_num_end` INT NOT NULL,
  PRIMARY KEY (`id_unidade`, `endereco_cep`, `endereco_num_end`),
  INDEX `fk_unidade_endereco1_idx` (`endereco_cep` ASC, `endereco_num_end` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `clinica`.`veterinario` (
  ...
  INDEX `fk_veterinario_unidade1_idx` (`unidade_id_unidade` ASC) VISIBLE,
  CONSTRAINT `fk_veterinario_unidade1`
    FOREIGN KEY (`unidade_id_unidade`)
    REFERENCES `clinica`.`unidade` (`id_unidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `clinica`.`consulta` (
  ...
  `horario_agendado` DATETIME NULL,
  ...
  `tutor_id_tutor` INT NOT NULL,
  `unidade_id_unidade` INT NOT NULL,
  PRIMARY KEY (`id_consulta`, `veterinario_id_veterinario`, `animal_id_animal`, `servico_id_servico`, `tutor_id_tutor`, `unidade_id_unidade`),
  ...
  INDEX `fk_consulta_tutor1_idx` (`tutor_id_tutor` ASC) VISIBLE,
  INDEX `fk_consulta_unidade1_idx` (`unidade_id_unidade` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_consulta_servico1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_consulta_tutor1`
    FOREIGN KEY (`tutor_id_tutor`)
    REFERENCES `clinica`.`tutor` (`id_tutor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_consulta_unidade1`
    FOREIGN KEY (`unidade_id_unidade`)
    REFERENCES `clinica`.`unidade` (`id_unidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `clinica`.`nota` (
  ...
  PRIMARY KEY (`id_nota`, `consulta_id_consulta`, `consulta_veterinario_id_veterinario`, `consulta_animal_id_animal`, `consulta_servico_id_servico`, `consulta_tutor_id_tutor`, `consulta_unidade_id_unidade`),
  UNIQUE INDEX `id_nota_UNIQUE` (`id_nota` ASC) VISIBLE,
  INDEX `fk_nota_consulta1_idx` (`consulta_id_consulta` ASC, `consulta_veterinario_id_veterinario` ASC, `consulta_animal_id_animal` ASC, `consulta_servico_id_servico` ASC, `consulta_tutor_id_tutor` ASC, `consulta_unidade_id_unidade` ASC) VISIBLE,
  CONSTRAINT `fk_nota_consulta1`
    FOREIGN KEY (`consulta_id_consulta` , `consulta_veterinario_id_veterinario` , `consulta_animal_id_animal` , `consulta_servico_id_servico` , `consulta_tutor_id_tutor` , `consulta_unidade_id_unidade`)
    REFERENCES `clinica`.`consulta` (`id_consulta` , `veterinario_id_veterinario` , `animal_id_animal` , `servico_id_servico` , `tutor_id_tutor` , `unidade_id_unidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `clinica`.`unidade_has_servico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `clinica`.`unidade_has_servico` ;

CREATE TABLE IF NOT EXISTS `clinica`.`unidade_has_servico` (
  `unidade_id_unidade` INT NOT NULL,
  `servico_id_servico` INT NOT NULL,
  `capacidade` INT NULL,
  PRIMARY KEY (`unidade_id_unidade`, `servico_id_servico`),
  INDEX `fk_unidade_has_servico_servico1_idx` (`servico_id_servico` ASC) VISIBLE,
  INDEX `fk_unidade_has_servico_unidade1_idx` (`unidade_id_unidade` ASC) VISIBLE,
  CONSTRAINT `fk_unidade_has_servico_unidade1`
    FOREIGN KEY (`unidade_id_unidade`)
    REFERENCES `clinica`.`unidade` (`id_unidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_unidade_has_servico_servico1`
    FOREIGN KEY (`servico_id_servico`)
    REFERENCES `clinica`.`servico` (`id_servico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
