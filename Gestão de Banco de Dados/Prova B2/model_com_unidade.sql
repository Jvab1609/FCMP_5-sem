...
CREATE TABLE IF NOT EXISTS `clinica`.`nota` (
  ...
  PRIMARY KEY (`id_nota`, `tutor_id_tutor`, `consulta_id_consulta`, `consulta_veterinario_id_veterinario`, `consulta_animal_id_animal`, `consulta_servico_id_servico`, `consulta_unidade_id_unidade`),
  UNIQUE INDEX `id_nota_UNIQUE` (`id_nota` ASC) VISIBLE,
  INDEX `fk_nota_tutor1_idx` (`tutor_id_tutor` ASC) VISIBLE,
  INDEX `fk_nota_consulta1_idx` (`consulta_id_consulta` ASC, `consulta_veterinario_id_veterinario` ASC, `consulta_animal_id_animal` ASC, `consulta_servico_id_servico` ASC, `consulta_unidade_id_unidade` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_nota_consulta1`
    FOREIGN KEY (`consulta_id_consulta` , `consulta_veterinario_id_veterinario` , `consulta_animal_id_animal` , `consulta_servico_id_servico` , `consulta_unidade_id_unidade`)
    REFERENCES `clinica`.`consulta` (`id_consulta` , `veterinario_id_veterinario` , `animal_id_animal` , `servico_id_servico` , `unidade_id_unidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
